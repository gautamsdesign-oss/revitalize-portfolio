import svgPaths from "./svg-q19epxfz22";
...
function Frame14() {
  return (
    <div className="absolute content-stretch flex flex-col font-['Satoshi_Variable:Regular',_sans-serif] font-normal gap-[11px] items-start leading-[0] left-[70px] top-[799px] w-[562px]">
...
export default function MacBookAir2() {
  return (
    <div className="bg-[#fafaff] relative size-full" data-name="MacBook Air - 2">
      <Frame20 />
      <Frame1 />
      <Frame14 />
      <Frame27 />
