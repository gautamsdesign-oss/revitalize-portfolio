import svgPaths from "./svg-u2kbl5jn9r";
...
function Frame14() {
  return (
    <div className="absolute content-stretch flex flex-col font-['Satoshi_Variable:Regular',_sans-serif] font-normal gap-[11px] items-start left-[70px] top-[799px] w-[562px]">
      <div className="flex flex-col justify-center leading-[0] relative shrink-0 text-[29px] text-black w-full">
      ...
      <p className="leading-[1.45] relative shrink-0 text-[#1c1c1c] text-[12px] w-full">Every project is an invitation to reimagine. From digital interfaces to immersive visuals, my work reveals what happens when adaptability and vision intersect—the result is a revitalized brand narrative, crafted for relevance and resonance.</p>
    </div>
  );
}
...
function Frame8() {
  return (
    <div className="content-stretch flex font-['Satoshi_Variable:Bold',_sans-serif] font-bold items-center justify-between leading-[20px] relative shrink-0 text-[14px] text-gray-900 w-full">
      <p className="relative shrink-0 w-[145px]">Project Name</p>
      <p className="relative shrink-0 text-nowrap text-right whitespace-pre">01</p>
    </div>
  );
}
...
function Frame9() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-start relative shrink-0 w-full">
      <Frame8 />
      <p className="font-['Satoshi_Variable:Regular',_sans-serif] font-normal leading-[1.45] relative shrink-0 text-[12px] text-black w-full">Lorem ipsum dolor sit amet consectetur. Ullamcorper nullam ipsum eu etiam nunc eget.</p>
    </div>
  );
}
...
function Frame15() {
  return (
    <div className="content-stretch flex font-['Satoshi_Variable:Bold',_sans-serif] font-bold items-center justify-between leading-[20px] relative shrink-0 text-[14px] text-gray-900 w-full">
      <p className="relative shrink-0 w-[145px]">Project Name</p>
      <p className="relative shrink-0 text-nowrap text-right whitespace-pre">02</p>
    </div>
  );
}
...
function Frame23() {
  return (
    <div className="content-stretch flex font-['Satoshi_Variable:Bold',_sans-serif] font-bold items-center justify-between leading-[20px] relative shrink-0 text-[14px] text-gray-900 w-full">
      <p className="relative shrink-0 w-[145px]">Project Name</p>
      <p className="relative shrink-0 text-nowrap text-right whitespace-pre">03</p>
    </div>
  );
}
...
function Frame25() {
  return (
    <div className="content-stretch flex font-['Satoshi_Variable:Bold',_sans-serif] font-bold items-center justify-between leading-[20px] relative shrink-0 text-[14px] text-gray-900 w-full">
      <p className="relative shrink-0 w-[145px]">Project Name</p>
      <p className="relative shrink-0 text-nowrap text-right whitespace-pre">04</p>
    </div>
  );
}
...
function Frame27() {
  return (
    <div className="absolute content-center flex flex-wrap gap-[16px] items-center left-[70px] top-[918px] w-[1141px]">
      <Frame10 />
      <Frame11 />
      <Frame12 />
      <Frame13 />
  ...
  return (
    <div className="h-[44px] relative rounded-[50px] shrink-0 w-[129px]" data-name="Button">
      <div className="box-border content-stretch flex h-[44px] items-center justify-center overflow-clip pb-[10px] pl-[18px] pr-[20px] pt-[12px] relative w-[129px]">
        <p className="font-['PP_Editorial_New:Regular',_sans-serif] leading-[20px] not-italic relative shrink-0 text-[#1c1c1c] text-[14px] text-nowrap whitespace-pre">My Resume</p>
      </div>
...
function Frame4() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[23px] items-start left-[160px] top-[187px] w-[562px]">
      <p className="font-['Satoshi_Variable:Regular',_sans-serif] font-normal leading-[1.45] min-w-full relative shrink-0 text-[#1c1c1c] text-[12px]" style={{ width: "min-content" }}>
        Adaptability isn’t just a skill—it’s my foundation. With three years immersed in diverse industries, I’ve honed a fast, forward-thinking approach that unearths clarity in complexity. Obstacles are catalysts, and every brand I partner with emerges with renewed energy and presence.
      </p>
      <Frame3 />
    </div>
  );
...
function Frame22() {
  return (
    <div className="absolute h-[305px] top-[2292px] w-[867px]" style={{ left: "calc(12.5% + 39px)" }}>
...
function Frame30() {
  return (
    <div className="content-stretch flex font-['Satoshi_Variable:Bold',_sans-serif] font-bold items-center justify-between leading-[20px] relative shrink-0 text-[14px] text-gray-900 text-nowrap w-full whitespace-pre">
      <p className="relative shrink-0">Name</p>
      <p className="relative shrink-0 text-right">Company</p>
    </div>
  );
}
...
function Frame17() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[25px] items-start left-[70px] top-[2717px] w-[1140px]">
      <Frame28 />
      <Frame16 />
    </div>
  );
...
function Frame19() {
  return (
    <div className="absolute bg-[#1c1c1c] h-[263px] left-0 overflow-clip top-[3348px] w-[1280px]">
...
export default function Work() {
  return (
    <div className="bg-[#fafaff] relative size-full" data-name="Work">
      <Frame20 />
      <Frame1 />
      <Frame14 />
      <Frame27 />
